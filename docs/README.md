...
| [PR review contract](pr-review.md) | Current input delivery, coverage limits and false-positive checks |
| [Specialist PR review](pr-review-specialists.md) | Model/role mapping, routing, coverage and conditional synthesis |
...
| [PR-review panel](runbooks/pr-review-panel.md) | Specialist failure diagnosis, Kiro readiness and credential recovery |
